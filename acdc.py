...
class ACDCApp:
    def __init__(self, root):
        self.root = root
        self.root.title("AC/DC - Power Up")
    ...
    def create_widgets(self):
        ...
        # Imagen del álbum
        album_image_path = "albumn4.png"  # Cambia la ruta si es necesario
        ...
        album_description = (
            ...
            "Duración: 41:03\n"
            "\n"
            "'Power Up' es un homenaje al legado de AC/DC y una demostración "
            "de que el espíritu del rock nunca muere. Incluye éxitos como 'Shot in the Dark', "
            "'Demon Fire' y 'Realize'."
        )
        ...
        album5_image_path = "album5.jpg"  # Cambia la ruta si es necesario
        if os.path.exists(album5_image_path):
            album5_img = Image.open(album5_image_path).resize((200, 200))
            album5_img = ImageTk.PhotoImage(album5_img)
            album5_label = tk.Label(self.root, image=album5_img, bg=self.bg_color)
            album5_label.image = album5_img
            album5_label.place(x=180, y=45)     
    ...
    def open_Perfil(self):
         ...
         Perfil_window.mainloo        
                
        
    def load_songs(self):
        """Carga las canciones del álbum 'Power Up'."""
        self.songs = [
            "Realize.mp3",
            "Rejection.mp3",
            "Shot in the Dark.mp3",
            "Through the Mists of Time.mp3",
            "Kick You When You're Down.mp3",
            "Witch's Spell.mp3",
            "Demon Fire.mp3",
            "Wild Reputation.mp3",
            "No Man's Land.mp3",
