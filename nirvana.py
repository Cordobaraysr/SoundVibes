...
class NirvanaApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Nirvana - Nevermind")
    ...
    def create_widgets(self):
        ...
        # Imagen del álbum
        album_image_path = "albumn5.png"  # Cambia la ruta si es necesario
        ...
        album_description = (
            "Artista: Nirvana\n"
            "Álbum: Nevermind\n"
            "Lanzamiento: 24 de septiembre de 1991\n"
            "Género: Grunge, Rock alternativo\n"
            "Duración: 42:38\n"
            "\n"
            "Este álbum icónico incluye canciones como 'Smells Like Teen Spirit', "
            "'Come as You Are', y 'Lithium'. Es considerado una de las mayores "
            "obras del grunge y del rock alternativo."
        )
        ...
        album5_image_path = "album4.jpg"  # Cambia la ruta si es necesario
    ...
    def load_songs(self):
        """Carga las canciones del álbum 'Nevermind'."""
        self.songs = [
