...
class ArianaGrandeApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Ariana Grande - Thank U, Next")
    ...
    def create_widgets(self):
        ...
        album_description = (
            ...
            "Duración: 41:11\n"
            "\n"
            "Este álbum incluye éxitos como '7 Rings', 'Thank U, Next' y "
            "'Break Up With Your Girlfriend, I'm Bored'. Es una oda a la "
            "autoaceptación y el crecimiento personal."
        )
        ...
        album2_image_path = "album2.jpg"  # Cambia la ruta si es necesario
        if os.path.exists(album2_image_path):
            album2_img = Image.open(album2_image_path).resize((200, 200))
            album2_img = ImageTk.PhotoImage(album2_img)
            album2_label = tk.Label(self.root, image=album2_img, bg=self.bg_color)
            album2_label.image = album2_img
            album2_label.place(x=180, y=45)            
    ...
    def load_songs(self):
        """Carga las canciones del álbum 'Thank U, Next'."""
        self.songs = [
            "Imagine.mp3",
            "Needy.mp3",
            "NASA.mp3",
            ...
            "7 Rings.mp3",
            "Thank U, Next.mp3",
            "Break Up With Your Girlfriend.mp3"
        ]
